...
class UserInterface:
    def __init__(self,quiz_brain:QuizBrain):
        ...
        self.true_button = Button(image=self.true_image, highlightthickness=0, border=False, command=self.true_pressed)
        self.true_button.grid(row=2, column=0)

        self.false_image = PhotoImage(file="images\\false.png")
        self.false_button = Button(image=self.false_image, highlightthickness=0, border=False,
